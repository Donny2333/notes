...
<div id='nav'>
    ...
    <div style="display: inline-block">
        ...
        <a class="w_top" onclick="$('body,html').animate({ scrollTop: $('#w_php').offset().top }, 200);"><i
                    class="fa fa-tags"></i> PHP参数</a>
        <a class="w_top" onclick="$('body,html').animate({ scrollTop: $('#w_module').offset().top }, 200);"><i
                    class="fa fa-cogs"></i> 组件支持</a>
        <a class="w_top" onclick="$('body,html').animate({ scrollTop: $('#w_module_other').offset().top }, 200);"><i
                    class="fa fa-cubes"></i> 第三方组件</a>
        <a class="w_top" onclick="$('body,html').animate({ scrollTop: $('#w_db').offset().top }, 200);"><i
                    class="fa fa-database"></i> 数据库支持</a>
        <a class="w_top" onclick="$('body,html').animate({ scrollTop: $('#w_performance').offset().top }, 200);"><i
                    class="fa fa-tachometer"></i> 性能检测</a>
    </div>
</div>
<div id="page">
    <!--服务器相关参数-->
        ...
        <table>
            ...
            <tr>
                ...
                <td colspan="5"><?php if ('/' == DIRECTORY_SEPARATOR) {
                        echo $cpu_show . " | <a href='" . $phpSelf . "?act=cpu_percentage' target='_blank' class='static'>查看图表 <i class=\"fa fa-external-link\"></i> </a>";
                    } else {
                        echo "暂时只支持Linux系统";
                    } ?>
                </td>
            ...
            <tr>
                ...
                <td colspan="5">
                    ...
                    if ($sysInfo['memCached'] > 0) {
                        ...
                        %
                        <div class="bar">
                            <div id="barmemRealPercent" class="barli_blue2"
                                 style="width:<?php echo $memRealPercent ?>%">&nbsp;
                            </div>
                        </div>
                        <?php
                    }
    ...
    <table>
        ...
        <tr>
            ...
            <td width="18%"><?php if ($PHP_VERSION > 2) {
                    echo (get_cfg_var("zend_loader.enable")) ? '<font color=green><i class="fa fa-check"></i></font>' : '<font color=red><i class="fa fa-times"></i></font>';
                } else {
    ...
    <table>
        ...
        <tr>
            ...
            <td><?php if (extension_loaded('sqlite3')) {
                    ...
                    if (isfun("sqlite_close") == '<font color="green"><i class="fa fa-check"></i></font>') {
                        ...
                        <tr>
                            <td colspan="11" class="suduk">
                                <table align="center" width="550" border="0" cellspacing="0" cellpadding="0" height="8"
                                       class="suduk" style="box-shadow:0 0 0;">
                                    <tr>
